...
- **Silently filter cSpell noise on technical terms.** Don't write rebuttal sentences about cSpell false positives on library names, CLI names, or domain terms. Respond only to real code or grammar issues.
