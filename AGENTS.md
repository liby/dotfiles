...
- **Herdr integrations**: For `.chezmoiscripts/run_onchange_after_07-install-herdr-integrations.sh.tmpl`, also read [Herdr integrations](.github/CONCEPTS.md#herdr-integrations).
