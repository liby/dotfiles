...
- Agent skill changes: run `ruby dot_agents/skills/scripts/validate-skills.rb --include-deployed-snow --smoke` before reporting done. Update `CLI_SMOKE_COMMANDS` in it when adding or removing a CLI-backed skill.
