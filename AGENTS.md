...
| Codex | `.chezmoitemplates/codex/**`, `dot_codex/**`, `.chezmoiscripts/run_onchange_after_setup-codex-requirements.sh.tmpl`, `~/.codex/config.toml`, `/etc/codex/requirements.toml`, the bundled Browser cache | [Codex configuration](.github/CONCEPTS.md#codex-configuration) |
