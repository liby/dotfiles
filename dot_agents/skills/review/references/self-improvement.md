...
Point to long evidence instead of pasting it. Write to the active private review journal when one is configured; otherwise return a `Self-improvement candidate` section in the review output. Public skill files receive only distilled rules.
